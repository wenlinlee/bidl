...
var opts struct {
	GroupAddress string `long:"groupaddress" default:"224.0.0.0:7777" description:"The group address"`
	...
	SortLength   int    `long:"sortlength" default:"0" description:"length of quicksort array"` //@author wenlinli
}
...
func main() {
	...
	if opts.ND != 0 && opts.Conflict != 0 {
		...
		return
	} else if opts.SortLength != 0{
		txns = GenerateSortWorkload(opts.SortLength, opts.Num, opts.Orgs)
	} else if opts.ND != 0 {
