...
public class BidlFrontend extends Thread {
    ...
    public static final BlockingQueue<byte[]> txBlockingQueue = new LinkedBlockingQueue<>(500000);
    ...
    @Override
    public void run() {
        InetSocketAddress groupAddress = new InetSocketAddress("224.0.0.0", 7777);
    ...
    private class SequencerDecodeHandler extends ChannelInboundHandlerAdapter {
        ...
        public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
            ...
            if (Arrays.equals(magicNum, MagicNumTxn)) {
                ...
                logger.info("bidl: execution result received, send persist.");
                for (int i=0; i<4; i++) {
