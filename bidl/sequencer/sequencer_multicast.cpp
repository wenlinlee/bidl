 ...
 *  4. Multicast the processed packet to the group address 224.0.0.0:7777.
 */
#include <stdio.h>
#include <sys/types.h>
#include <chrono>
...
int main(int argc, char *argv[]) {
    ...
    */
    ...
    cout << "Group Address:" << "224.0.0.0" << endl;
    ...
    */
    ...
    multicast_addr.sin_addr.s_addr = inet_addr("224.0.0.0");
    multicast_addr.sin_port = htons(BROA_PORT);
    socklen_t socklen = sizeof(multicast_addr);
    printf("Multicast Address is 224.0.0.0");
    ...
    */
    ...
    while(1) {
        ...
        //struct timeb t;
        //ftime(&t);
        //std::cout << t.time*1000 + t.millitm << std::endl;
        //timestamp = t.time*1000 + t.millitm
        //uint64_t *ptr0 = (uint64_t*)(recv_buf + 4);
        //*ptr = timestamp;
